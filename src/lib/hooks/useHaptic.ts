 ...
 *
 * Возвращаемый объект стабилен между рендерами (useMemo с пустыми deps) —
 * безопасно класть его в зависимости useEffect/useCallback потребителей,
 * не вызывая лишних переподписок.
 */
